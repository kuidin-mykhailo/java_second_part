...
public class Interface {
    ...
    public static MyLinkedList<Employer> object = new MyLinkedList<>();
        ...
        while (choose != 0) {
            switch (choose) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    object = Generator.generator(1000000);
                    break;
                case 12:
    ...
    private static MyLinkedList download() {
        MyLinkedList<Employer> output = new MyLinkedList<>();
        int choose;
        System.out.println("What type of saving do you wish for: ");
        System.out.println("1 - XML");
        System.out.println("2 - Standard Serialization");
        ...
        while (choose != 0) {
            switch (choose) {
                case 1:
                    ...
                    }, input.toArray(new Employer[input.size()]));
                    break;
                case 2:
                    input.sort(new Comparator<Employer>() {
                        @Override
    ...
    private static void settingSearch(MyLinkedList<Employer> input) {
